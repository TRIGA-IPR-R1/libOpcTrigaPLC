...
struct PLC_DATA {
  ...
  //
  float BarraReg     = -1; //ns=2;IoConfig_Globals_Mapping.inBarraReg   (%IW5)  //Barra de Regulação
  float BarraCon     = -1; //ns=2;IoConfig_Globals_Mapping.inBarraCon   (%IW6)  //Barra de Controle
  float BarraSeg     = -1; //ns=2;IoConfig_Globals_Mapping.inBarraSeg   (%IW7)  //Barra de Segurança
  float CLogALog     = -1; //ns=2;IoConfig_Globals_Mapping.inCLogALog   (%IW17) //Canal Logaritico - Aquisição Logarítima
  float CLogALin     = -1; //ns=2;IoConfig_Globals_Mapping.inCLogALin   (%IW18) //Canal Logaritico - Aquisição Linear
  float CLogAPer     = -1; //ns=2;IoConfig_Globals_Mapping.inCLogAPer   (%IW19) //Canal Logarítimo - Aquisição Período
  float CParALin     = -1; //ns=2;IoConfig_Globals_Mapping.inCParALin   (%IW14) //Canal Partida - Aquisição Linear
  float CParALog     = -1; //ns=2;IoConfig_Globals_Mapping.inCParALog   (%IW15) //Canal Partida - Aquisição Log
  ...
  float SRadPoc      = -1; //ns=2;IoConfig_Globals_Mapping.inSRadPoc    (%IW29) //Sensor Radiação Poço
  float SRadRes      = -1; //ns=2;IoConfig_Globals_Mapping.inSRadRes    (%IW30) //Sensor Radiação Resinas
  float SRadSaiSec   = -1; //ns=2;IoConfig_Globals_Mapping.inSRadSaiSec (%IW31) //Sensor Radiação Saída Secundário
  float SRadAer      = -1; //ns=2;IoConfig_Globals_Mapping.inSRadAer    (%IW32) //Sensor Radiação Aerossois
  ...
  float SPt100EntPri = -1; //ns=2;s=GVL.SPt100EntPri                    (%MD2)  //PT100_TEMP_ENT_PRIM
  float SPt100SaiPri = -1; //ns=2;s=GVL.SPt100SaiPri                    (%MD3)  //PT100_TEMP_SAI_PRIM
  float SPt100EntSec = -1; //ns=2;s=GVL.SPt100EntSec                    (%MD4)  //PT100_TEMP_ENT_SEC
  float SPt100SaiSec = -1; //ns=2;s=GVL.SPt100SaiSec                    (%MD5)  //PT100_TEMP_SAI_SEC
